...
if(NOT ONIKA_MPIRUN_CMD_DBG)
  set(ONIKA_MPIRUN_CMD_DBG ${ONIKA_MPIRUN_CMD})
endif()
...
function(MakeRunCommand_internal ENABLE_DEBUGGER CMDVAR NUMPROCS NUMCORES ENABLE_PREALLOC USES_OMP RESULTCMDVAR)
  ...
  if(${NUMPROCS} GREATER 0 OR ONIKA_ALWAYS_USE_MPIRUN)
    ...
    set(${RESULTCMDVAR} ${ONIKA_MPIRUN_CMD${MPIDBG}} ${MPIEXEC_NUMPROC_FLAG${MPIDBG}} ${NUMPROCS} ${MPIEXEC_NUMCORES_OPT} ${CMD_PREALLOC_FLAG} ${MPIEXEC_PREFLAGS${MPIDBG}} ${DBG_PREFIX} ${MTCommand} ${MPIEXEC_POSTFLAGS${MPIDBG}} PARENT_SCOPE)
